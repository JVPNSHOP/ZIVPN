...
/* Password full-visible & wrap nicely */
.code-wrap{font-family:ui-monospace,Menlo,monospace;background:#f1f5f9;border-radius:.5rem;padding:.25rem .5rem;word-break:break-all;white-space:normal;display:block}
/* Icon-only copy button, same size every row */
      ...
      <table class="w-full text-left align-middle table-tight table-fixed">
        ...
        <tbody class="tiny">
          ...
          <tr class="border-t">
            ...
            <td class="py-1 align-middle">
              <div class="flex items-center gap-2">
                <span class="code-wrap" title="{{r['password']}}">{{r['password']}}</span>
                <button onclick="copyText('{{r['password']}}',this)" class="icon-btn" aria-label="Copy" title="Copy">
            ...
            <td class="py-1 text-slate-600 align-middle">{{r['expires']}}</td>
            <td class="py-1 align-middle">
              {% if not r['expired'] %}
