...
<div class="fab">
  <a href="https://t.me/Pussy1990" target="_blank" rel="noopener" class="bg-sky-600 hover:bg-sky-500 text-white">
    <!-- Telegram icon -->
    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
      <path d="M9.04 15.47l-.39 5.49c.56 0 .8-.24 1.09-.53l2.62-2.52 5.43 3.97c1 .55 1.71.26 1.98-.93l3.6-16.85c.32-1.5-.54-2.09-1.52-1.73L1.16 9.64c-1.46.57-1.44 1.39-.25 1.76l5.34 1.66L19.36 6.1c.62-.41 1.18-.18.72.23"/>
    </svg>
  </a>
  <a href="/logout" class="bg-slate-700 hover:bg-slate-600 text-white">
    <!-- Logout icon -->
    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
      <path d="M10 17v2H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h5v2H5v10h5zm4.293-1.293 2.293-2.293H9v-2h7.586l-2.293-2.293 1.414-1.414L21.414 12l-4.707 4.707-1.414-1.414z"/>
    </svg>
  </a>
</div>
...
<header class="bg-gradient-to-r from-slate-900 to-slate-800 text-white">
  <div class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
    ...
    <!-- Clean VPS IP + Server Time (no big rounded bg) -->
    <div class="text-right text-[12px] leading-tight">
...
{{ msg }}
  ...
  <!-- Form + Table (unchanged except earlier tweaks) -->
