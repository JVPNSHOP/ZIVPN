...
# Script By: JueHtet (modified to allow unlimited logins per password)
...
{{ msg }}
      ...
      <div class="mt-1 text-[11px] text-emerald-800/80">Unlimited users per password</div>
    </div>
    {% endfor %}
  {% endif %}
  {% endwith %}
