...
# Fix networking issues - Add proper iptables rules
...
# Add proper NAT and forwarding rules
...
echo "======================================"
echo "IMPORTANT: Make sure your VPS firewall allows UDP port 5667"
echo "and TCP ports 8088 (admin panel) and 22 (SSH)"
BASH
