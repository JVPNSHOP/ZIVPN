...
# Patch: make Password "Copy" + "Edit" buttons reliably clickable
# Script By: JueHtet
...
<script>
// Robust Copy + stopPropagation (prevents table/form swallowing taps)
function copyText(t, btn){
  const ev = window.event || undefined; if (ev && ev.stopPropagation) ev.stopPropagation();
  function ok(){
    if(btn){
...
button.btn-slim { pointer-events:auto; }
</style>
</head>
          ...
          <tr class="border-t">
            ...
            <td class="py-1">
              <div class="flex items-center gap-1.5 flex-wrap">
                ...
                <!-- FIXED: stopPropagation + return false; type=button -->
                <button type="button" onclick="return copyText({{ r['password']|tojson }}, this)" class="btn-slim bg-slate-800 text-white rounded text-[11px]" role="button" tabindex="0">Copy</button>
            ...
            <td class="py-1">
              <div class="flex items-center gap-1.5">
                <!-- FIXED: stopPropagation inside fillForm + return false -->
                <button type="button" onclick="return fillForm({{ r['username']|tojson }}, {{ r['password']|tojson }}, {{ r['expires']|tojson }})" class="btn-slim bg-amber-500 hover:bg-amber-400 text-white rounded text-[11px]" role="button" tabindex="0">Edit</button>
