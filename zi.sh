cat > zi.sh <<'BASH'
#!/bin/bash
# ZIVPN UDP + Tailwind Web Panel (Multi-login allowed)
# Script By: JueHtet
...
{{ msg }}
      ...
      <div class="mt-1 text-[11px] text-emerald-800/80">Unlimited Multi-Login Allowed</div>
    </div>
    {% endfor %}
  {% endif %}
  {% endwith %}
